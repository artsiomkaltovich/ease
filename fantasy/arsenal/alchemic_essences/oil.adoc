...
- **Harder to Hold:** Items and creatures covered in oil are slippery, making them harder to grab. Oil increases the difficulty of holding or grabbing such items or creatures.
