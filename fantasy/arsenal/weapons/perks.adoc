...
[[parry]]
== Parry
Spoil an incoming attack, subtracting your skill value with this weapon from its roll.
Requires 1 EP or 1 <<item-use-token, item use token>>.
...
[[powerful-attack]]
== Powerful Attack N
When landing a successful attack, you can expose the enemy's weakness and deal *N* extra damage by spending 1 EP or 1 <<item-use-token>>.
...
[[reliable-strike]]
== Reliable Strike N
Spend 1 EP or 1 <<item-use-token>> to make a roll with a result of *N*.
