...
- [[light-armor-block]]Armor Block: Reduces damage received from attacks by *1* at the cost of 1 <<item-use-token, item use token>>. Requires a <<short-action, short action>>, and can be used any number of times per round.
...
- [[heavy-armor-block]]Armor Block: Reduces damage received from attacks by *2* at the cost of 1 <<item-use-token, item use token>>. Requires a <<short-action, short action>>, and can be used any number of times per round.
