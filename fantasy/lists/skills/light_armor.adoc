...
== Rank I
- [[light-armor-block]]Armor Block: Reduces damage received from attacks by *1* at the cost of 1 EP and 1 <<item-usage-token, item use slot>>. Does not require an action.
