...
Seeing a target is required for certain actions and attacks. However, characters can still attempt to attack an adjacent target based on hearing or other senses. Such attacks incur a penalty of **one** die. These characters can still be affected by area-of-effect abilities. 
