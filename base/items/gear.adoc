...
The number of uses for these features is determined by the number of [[item-use-token]]*item usage tokens*, which by default equals the <<skill-value, skill value>>. To reset the uses, a successful repair skill check is required.
