= Insult
The art of delivering cutting remarks to provoke or demoralize others. Primary stat is <<chr, Charisma>>.
...
- Provoke: An insulted creature can't move away from you this round.
