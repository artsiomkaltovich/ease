...
- [[hold-unarmed]]<<hold, Hold>>: Attempt to hold a target and attack it as a single action by spending 1 EP. On success, the target is considered held and the attack deals its weapon damage. This action can't be used in the same round <<attack>> or <<grapple,Grapple>> were used.

== Rank II
- Disarm: On a successful disarm attempt, you also deal weapon damage.
