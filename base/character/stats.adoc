...
| [[ep]]Energy Points (EP)
| Representing a creature's vitality and its ability to achieve goals. EP can be spent to perform or enhance certain actions. A creature may spend 1 EP to reroll 1 die, with any number of dice rerolled once per check.
