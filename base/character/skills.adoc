...
In some cases, not all information can be obtained from one test, and additional tests may be required. The game master can also decide to provide false information on a failure, especially when every die comes up 1.
